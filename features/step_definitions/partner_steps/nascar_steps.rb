Given(/^NAS \- I add an item to the cart$/) do
  visit FigNewton.partners.nascar
  click_link "Choose Size S"
  find("#addToCart").click
end

Given(/^NAS \- I apply the Troop ID discount$/) do
...
Given(/^NAS \- I verify the Troop ID discount has been applied$/) do
