Given(/^NYG \- I add an item to the cart$/) do
  visit FigNewton.partners.ny_giants
  click_link "Choose Size S"
  find("#addToCart").click
end

Given(/^NYG \- I apply the Troop ID discount$/) do
...
Given(/^NYG \- I verify the Troop ID discount has been applied$/) do
