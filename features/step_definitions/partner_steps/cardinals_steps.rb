Given(/^AZCD \- I add an item to the cart$/) do
  visit FigNewton.partners.az_cardinals
  click_link "Choose Size S"
  find("#addToCart").click
end

Given(/^AZCD \- I apply the Troop ID discount$/) do
...
Given(/^AZCD \- I verify the Troop ID discount has been applied$/) do
