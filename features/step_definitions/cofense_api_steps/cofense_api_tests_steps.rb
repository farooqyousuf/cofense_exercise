...
Given("I send a GET single user request to a dummy API site") do
	@response = HTTParty.get(FigNewton.api_dummy_site.users_one_url)	#stores the the api response in a variable  
	puts "This is the API URL endpoint that is being tested: #{FigNewton.api_dummy_site.users_one_url}"
...
Given("I send a GET all users request to a dummy API site") do
	@response = HTTParty.get(FigNewton.api_dummy_site.users_url)		#stores the the api response in a variable  
	puts "This is the API URL endpoint that is being tested: #{FigNewton.api_dummy_site.users_url}"
end
...
Given("I send a DELETE request to the users endpoint") do
	@response = HTTParty.delete(FigNewton.api_dummy_site.users_url)		#stores the the api response in a variable  
	puts "This is the API URL endpoint that is being tested: #{FigNewton.api_dummy_site.users_url}"
end
