...
Feature: Teacher verification using document upload
  ...
  Scenario: Dupe attempt test for teacher doc upload (Error code 91)
    ...
    * I should see the error message "We’re sorry, it appears you have already verified your teacher status on a different account. Please sign in using your existing credentials."
