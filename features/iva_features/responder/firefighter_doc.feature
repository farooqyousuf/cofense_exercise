...
Feature: Responder verification as a firefighter using document upload
  ...
  Scenario: Denied attempt for firefighter doc upload verification (Error code 45)
    ...
    * I should see the error message "We're sorry, but we are unable to verify the information you provided. The information entered must ...ion on official records. Note: If you've recently had a name change, try your maiden or prior name."
