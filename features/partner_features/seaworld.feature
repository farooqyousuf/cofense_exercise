...
Feature: Test the ID.me Seaworld Waves of Honor Partner Integrations
  ...
  Scenario: Test Seaworld Orlando Active Military Integration
    ...
    * I verify that my "Seaworld Orlando" service member Complimentary tickets are available 

  Scenario: Test Seaworld San Antonio Active Military Integration 
    * I visit the waves of honor "Seaworld San Antonio" Integration 
    * I log in with my Id.me military account
    * I verify that my "Seaworld San Antonio" service member Complimentary tickets are available 

  Scenario: Test Seaworld San Diego Active Military Integration 
    * I visit the waves of honor "Seaworld San Diego Military" Integration 
    * I log in with my Id.me military account
    * I verify that my "Seaworld San Diego Military" service member Complimentary tickets are available 

  Scenario: Test Busch Gardens Tampa Active Military Integration
  ...
  Scenario: Test Sesame Place Langhorne Active Military Integration 
    * I visit the waves of honor "Sesame Place Langhorne" Integration
    * I log in with my Id.me military account 
  ...
  Scenario: Test Adventure Island Tampa Active Military Integration 
    ...
    * I click the Active Duty Program ticket link for Adventure Island Tampa
    * I log in with my Id.me military account
    * I verify that my "Adventure Island Tampa" service member Complimentary tickets are available 

  Scenario: Test Water Country USA Williamsburg Military Integration
  ...
  Scenario: Test Seaworld Orlando Veteran Promotion 
    ...
    * I verify that my "Seaworld Orlando Veteran" discount tickets are available 

  Scenario: Test Seaworld Busch Gardens Williamsburg Veteran Promotion
    * I visit the waves of honor "Busch Gardens Williamsburg Veteran" Integration
    * I log in with my Id.me veteran account
    * I verify that my "Busch Gardens Williamsburg Veteran" discount tickets are available 

  Scenario: Test Seaworld Sesame Place Langhorne Veteran Promotion 
