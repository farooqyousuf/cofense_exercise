...
- IDME-4262: Shop: Update steps to use cucumber expressions
...
# 2.5.11 (8/20/18)
- AWE-1624: Canadian Student Happy Path Test
...
- AWE-1529: Fix Mobile IVA Student Smoke Tests
...
- IDME-4217: Fix User verifies a Military Group Affiliation test
...
# 2.4.6 (8/1/2017)
- INT-1711: Add properties check in Admin Tool for Mil Email IVA tests
...
## 2.3.27 (6/27/17)
- INT-1433: Denied user SCRA form (Admin) Cucumber Test
...
- CORE-7528: Fix Teacher Doc Dupe IVA test
...
## 2.2.44 (10/11/2016)
- IDME-2827: Update Ashley Stewart, Caesars, Merrell, MLBtv, Limited Partner tests
## 2.2.43 (10/06/2016)
- IDME-2795: Add Wallet homepage smoke test
...
## 2.2.9 (07/17/2016)
- QA-308: Marketplace Offer spec for Groups filter
...
- HOTFIX: Typo in emt doc upload feature
